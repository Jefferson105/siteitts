<?php 
    /*
        Template Name: Produto Pimenta Extra Forte
    */

    $GLOBALS['h1'] = "Molho de Pimenta Extra Forte";
    $GLOBALS['isProduto'] = true;

    get_header('about');
?>
<main>
        <p class="produtos-breadcrumb"><span>produtos</span> | <span>Molhos</span> | <span>Molho de Pimenta Extra Forte Inttenso foods</span></p>
        <section class="produtos-individual">
            <figure class="produtos-individual-img">
                <img class="produtos-individual-img-prod" src="<?php echo theme_image('produtos/Molho de pimenta EXTRA-forte 900ml.png') ?>" />
            ...
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome">Molho de Pimenta Extra Forte 150ml e 900ml</h3>
