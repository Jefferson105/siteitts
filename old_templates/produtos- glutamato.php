<?php 
    /*
        Template Name: Produto Glumato
    */

    $GLOBALS['h1'] = "Glumato Monossódico";
    $GLOBALS['isProduto'] = true;

    get_header('about');
?>
<main>
        <p class="produtos-breadcrumb"><span>produtos</span> | <span>Condimentos</span> | <span>GLUTAMATO MONOSSÓDICO Inttenso foods</span></p>
        <section class="produtos-individual">
            <figure class="produtos-individual-img">
                <img class="produtos-individual-img-prod" src="<?php echo theme_image('produtos/condimento_glumato.png') ?>" />
                <img class="produtos-individual-img-info" src="<?php echo theme_image('fundo_produto.png') ?>" />
                <p class="produtos-individual-img-txt">
                    <span>Peso Líquido:100g.</span><br />
                    <span>Validade: VIDE LOTE</span>
                </p>
            </figure>
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome">GLUTAMATO MONOSSÓDICO 100g</h3>
                    ...
                    <div class="produtos-individual-ingrediente">
                        ...
                        <p class="produtos-individual-ingrediente-txt">GLUTAMATO MONOSSÓDICO.  Alérgicos: Não contém glúten.
                        </p>
                    </div>
                </div>
            </div>
