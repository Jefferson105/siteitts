...
<body>
    <header class="header">
        ...
        <h1 class="produtos-h1">Molho de Pimenta Extra Forte Inttenso foods</h1>
    </header>
<main>
        ...
        <section class="produtos-individual">
            <figure class="produtos-individual-img">
                <img class="produtos-individual-img-prod" src="img/produtos/Molho de pimenta EXTRA-forte 900ml.png" />
