...
<body>
    <header class="header">
        ...
        <h1 class="produtos-h1">Tomate seco inttenso foods</h1>
    </header>
<main>
        ...
        <section class="produtos-individual">
            <figure class="produtos-individual-img">
                <img class="produtos-individual-img-prod" src="img/produtos/tomate-seco.png" />
            ...
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome">Tomate Seco Drenado 180g Inttenso foods</h3>
                    ...
                    <div class="produtos-individual-ingrediente">
                        ...
                        <p class="produtos-individual-ingrediente-txt">Tomates desidratados, óleo de girassol, azeite, açúcar, sal, cebola, alho, orégano e manjericão.
