...
<body>
    <header class="header">
        ...
        <h1 class="produtos-h1">Molho Inglês 150ml e 900ml</h1>
    </header>
<main>
        <p class="produtos-breadcrumb"><span>produtos</span> | <span>Molhos</span> | <span>Molho Inglês 150ml e 900ml</span></p>
        <section class="produtos-individual">
            <figure class="produtos-individual-img">
                <img class="produtos-individual-img-prod" src="img/produtos/MOLHO INGLES 150.png" />
            ...
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome">Molho Inglês 150ml e 900ml</h3>
                    ...
                    <div class="produtos-individual-ingrediente">
                        ...
                        <p class="produtos-individual-ingrediente-txt">Ingredientes: Água, vinagre, açúcar, sal, polpa de pimenta, polpa de alho, corante caramelo, benzoato de sódio, ácido cítrico e aroma de molho inglês.</p>
                    </div>
                </div>
            </div>
        </section>
        <p class="produtos-individual-modo"><i>Modo de conservação:</i> Conservar em local seco e arejado.  Depois de aberto conservar preferencialmente em geladeira.Válido por 30 dias depois de aberto.Alérgicos: Não contém glúten.</p>
    </main>
    <footer class="footer">
