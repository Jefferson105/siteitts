...
<body>
    <header class="header">
        ...
        <h1 class="produtos-h1">Pimenta do Reino em Grãos Inttenso foods</h1>
    </header>
<main>
        <p class="produtos-breadcrumb"><span>produtos</span> | <span>Condimentos</span> | <span>Pimenta do Reino em Grãos Inttenso foods</span></p>
        <section class="produtos-individual">
            <figure class="produtos-individual-img">
                <img class="produtos-individual-img-prod" src="img/produtos/condimento_pimenta_reino_grao.png" />
                <img class="produtos-individual-img-info" src="img/fundo_produto.png" />
                <p class="produtos-individual-img-txt">
                    <span>Peso Líquido:70g.</span><br />
                    <span>Validade: VIDE LOTE</span>
                </p>
            </figure>
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome">Pimenta do Reino Moída em Grãos 70g</h3>
                    ...
                    <div class="produtos-individual-ingrediente">
                        ...
                        <p class="produtos-individual-ingrediente-txt">Pimenta do Reino em grãos.  Alérgicos: Não contém glúten.
                        </p>
                    </div>
                </div>
            </div>
