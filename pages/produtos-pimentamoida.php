...
<body>
    <header class="header">
        ...
        <h1 class="produtos-h1">Pimenta do Reino Moída Inttenso foods</h1>
    </header>
<main>
        <p class="produtos-breadcrumb"><span>produtos</span> | <span>Condimentos</span> | <span>Pimenta do Reino Moída Inttenso foods</span></p>
        <section class="produtos-individual">
            ...
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome">Pimenta do Reino Moída 70g</h3>
                    ...
                    <div class="produtos-individual-ingrediente">
                        ...
                        <p class="produtos-individual-ingrediente-txt">Pimenta do Reino moída.  Alérgicos: Não contém glúten.
                        </p>
                    </div>
                </div>
            </div>
