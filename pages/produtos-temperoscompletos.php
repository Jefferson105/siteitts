...
<body>
    <header class="header">
        ...
        <h1 class="produtos-h1">Tempero Completo Inttenso foods</h1>
    </header>
<main>
        <p class="produtos-breadcrumb"><span>produtos</span> | <span>Tempero</span> | <span>Tempero Completo Inttenso foods</span></p>
        <section class="produtos-individual">
            <figure class="produtos-individual-img">
                <img class="produtos-individual-img-prod" src="img/produtos/Tempero completo 500g.png" />
            ...
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome">Tempero Completo 500g</h3>
                    ...
                    <div class="produtos-individual-ingrediente">
                        ...
                        <p class="produtos-individual-ingrediente-txt"> Sal, alho, cebola e condimentos. Alérgicos: Não contém glúten.
                        </p>
                    </div>
                </div>
            </div>
