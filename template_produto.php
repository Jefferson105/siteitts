<?php 
    /*
        Template Name: Template Produto
    */

    get_header('about');

    $nomeProduto = get_field('produto_nome');

    $GLOBALS['h1'] = $nomeProduto;
    $GLOBALS['isProduto'] = true;
?>
    <main>
        <p class="produtos-breadcrumb"><span>produtos</span> | <span>Condimentos</span> | <span><?php echo $nomeProduto; ?> Inttenso foods</span></p>
        <section class="produtos-individual">
            ...
            <div class="produtos-individual-info">
                <div class="produtos-individual-info-container"> 
                    <h3 class="produtos-individual-info-nome"><?php echo $nomeProduto; ?></h3>
